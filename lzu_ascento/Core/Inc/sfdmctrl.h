...
//stackforce6010
#define P_MIN2 -25.12f
#define P_MAX2 25.12f
#define V_MIN2 -65.0f
#define V_MAX2 65.0f
#define KP_MIN2 0.0f
...
extern void sf_fbdata(Joint_Motor_t *motor, uint8_t *rx_data,uint32_t data_len);
...
//6215电机
extern void mit_ctrl1(hcan_t* hcan, uint16_t motor_id, float pos, float vel,float kp, float kd, float torq);
//stackforce电机
