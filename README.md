...
## 腿部结构示意图(附长度比例)
<img width="351" height="381" alt="腿部结构" src="https://github.com/user-attachments/assets/39c33dc8-4cda-4d91-85c2-859b9caf60bf" /><br>
大致比例：   L1:L2:L3:L4:L5 = 1 : 1.0065 : 0.04621 : 1.0327 : 0.2418 <br>
L3与水平面夹角为45°<br>
使用solidworks建模时，赋好材质密度，到时候是需要质量评估，获得转动惯量等参数的
## bom表及成本
...
（讲一下如何选型电机：机器人关节一般都是关节减速电机，你会看到不同电机扭矩参数，复刻中小型轮腿机器人推荐额定扭矩3N-10N，robomaster那种都要20N+,30N+,轮电机的话，小轮腿比如达妙桌面轮足选用dmh3510,额定扭矩0.18N.M,我的毕设，dmh6215轮毂电机额定是1N.M，你还可以选本末电机，还有达妙的3519，大疆的3508电机，价格小贵，性能很好。轮毂可以自己画然后cnc加工，轮胎的话，根据需求定制比较好，聚氨酯材质等等。）
## 代码文件简介
1.core/inc:若干头文件<br>
...
（着重强调代码调试一定要弄清电机正方向，一定要弄清电机正方向，一定要弄清电机正方向，一般逆时针为正！！！当然还有陀螺仪六轴正方向，调试过程中非常重要）<br>
5.matlab中两个文件代码就达妙开源里的，生成K矩阵，然后参数拟合。根据自身重量修改相关参数。
## 手搓记录(试错参考)：
...
然后可以正常接收数据了<br>
2026.3.12:分配遥控器通道功能，现在可以实现遥控变腿长，前进后退，转向pd控制还在调<br>
2026.3.20:全部调试完成收尾
